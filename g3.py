...
def WindowPrint():
    ...
    [sg.Multiline(default_text=CorrectText,key='-keybox-', size=(60, 30))],
...
def mainBsc():
    ...
    block_3 = [
        ...
        [sg.Button('Exit', size=(20, 1), font='Any 8')],
    ]
    ...
    block_4 = [
        ...
        [sg.Image(data=fondoP2A, key='-CAMARA-', size=(480, 300))], 
    ]
    layout2 = [
        [sg.Column(top_banner, size=(630, 50), pad=(0, 0), background_color=DARK_HEADER_COLOR)],
        [sg.Column([[sg.Column(block_2, size=(140, 100), pad=BPAD_LEFT_INSIDE)],
                    [sg.Column(block_3, size=(140, 100), pad=BPAD_LEFT_INSIDE)]], pad=BPAD_LEFT, background_color=BORDER_COLOR),
        sg.Column(block_4, size=(430, 350), pad=BPAD_RIGHT)]]
...
block_2 = [[sg.Column([[sg.Button(image_data=fondoP2W, size=(10, 2), font='Any 8', key='-wifi-')]])]]

block_4 = [[sg.Image(data=fondo, size=Pf)]]

layout = [[sg.Column(top, size=(600, 60), pad=BPAD_TOP)],
          [sg.Column([[sg.Column(block_3, size=(100, 100), pad=BPAD_LEFT_INSIDE)],
                       [sg.Column(block_2, size=(100, 100), pad=(6, 1))]
                       ], pad=BPAD_LEFT, background_color='#2b475d'),
           sg.Column(block_4, size=(550,400))]]
